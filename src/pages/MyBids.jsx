                    ...
                    bids?.map(bid => (<tr key={bid._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-2'>
                          <p className={`px-3 py-1  text-xs rounded-full ${bid.category === 'Web Development' && 'text-blue-500 bg-blue-100/60'} &
                      ...
                      <td className='px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap'>
                        <div className='inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-yellow-100/60 text-yellow-500'>
                          ...
                          <h2 className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 ${bid.status === 'Pending' &&
